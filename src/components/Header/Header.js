  ...
  return (
    <>
      <header className=' row border-bottom borderc-4'>
          ...
          <div className=' col m33 textc-4 hover-textc-2 center large pointer' style={{padding:"34px 0px"}} onClick={() => funHandle()}>الدورات التعليمية  <span className='arrow'></span> </div>
      </header>
      {handle &&
        <nav>
