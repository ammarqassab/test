...
<PageTutorial apiLocalUrl='next' title='تعلم useRouter() next/router' description='التعرف على useRouter() next/router في مشروع Next.js' keywords='تعلم useRouter() next/router, Frontend developer, Next.js'>
<div className='mdx'>
