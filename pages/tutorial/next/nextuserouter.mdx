...
<CommonSEO title='تعلم useRouter() next/router' description='التعرف على useRouter() next/router في مشروع Next.js' keywords='تعلم useRouter() next/router, Frontend developer, Next.js'/>

<PageTutorial apiLocalUrl='next' namePage='تعلم useRouter() next/router'>
<div className='mdx'>
