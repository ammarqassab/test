        ...
        <>
            <PageTutorial apiLocalUrl='next'>
                <div className='mdx'>
                    ...
                    <pre>
                        <code>
                        npx create-next-app@latest app-name<br/>
                        # or<br/>
                        yarn create next-app app-name<br/>
                        # or<br/>
                        pnpm create next-app app-name<br/>
                        </code>
                    </pre>
                    <p>أذا كنت تريد استخدام <code>TypeScript</code> في المشروع جديد</p>
                    <pre>
                        <code>
                        npx create-next-app@latest --typescript app-name<br/>
                        # or<br/>
                        yarn create next-app --typescript app-name<br/>
                        # or<br/>
                        pnpm create next-app --typescript app-name<br/>
                        </code>
                    </pre>
                    <h1>بعد اكتمال تثبيت المشروع <code>Next.js</code> إتبع الخطوات التالية لتشغيل المشروع :</h1>
                    <ul>
                        <li>أفتح محرر الأوامر مثل <code>git bash</code> و أدخل الأمر التالي<code>npm run dev or yarn dev or pnpm dev</code> لبدء تشغيل خادم التطوير </li>
